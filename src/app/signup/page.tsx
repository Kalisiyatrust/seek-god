...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, Compass, Heart } from 'lucide-react';
...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden py-12">
      ...
      <div className="absolute top-0 left-1/3 w-96 h-96 bg-gold-200/30 rounded-full blur-3xl -translate-y-1/2" />
      <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-warm-200/30 rounded-full blur-3xl translate-y-1/2" />
        ...
        <div className="bg-card/80 backdrop-blur-xl border border-border/50 rounded-2xl shadow-xl p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-card/80 px-3 text-muted-foreground">or sign up with email</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            >
              <Compass className={cn('w-6 h-6', role === 'customer' ? 'text-primary' : 'text-muted-foreground')} />
              <div>
                <p className="text-sm font-medium">Find Purpose</p>
                <p className="text-[11px] text-muted-foreground">I want to discover</p>
              </div>
            </button>
            <button
              type="button"
            ...
            >
              <Heart className={cn('w-6 h-6', role === 'vendor' ? 'text-primary' : 'text-muted-foreground')} />
              <div>
                <p className="text-sm font-medium">Help Others</p>
                <p className="text-[11px] text-muted-foreground">I want to contribute</p>
              </div>
            </button>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className={cn(
                    'w-full h-11 pl-10 pr-4 rounded-lg border bg-background text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring',
